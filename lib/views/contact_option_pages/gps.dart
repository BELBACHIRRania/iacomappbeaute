...
class PlanAccesState extends State<PlanAcces>
  ...
  Widget _zoomminusfunction() {
    return Align(
      ...
      child: IconButton(
          icon: Icon(FontAwesomeIcons.searchMinus, color: Color(0xFFDABCB2),),
          onPressed: () {
            zoomVal--;
            _minus(zoomVal);
          }),
...
Marker iacombeautyMarker = Marker(
  markerId: MarkerId('iacombeauty'),
  position: LatLng(48.8011630, 2.3249030),
  infoWindow: InfoWindow(title: 'IΛCOM Beauty'),
